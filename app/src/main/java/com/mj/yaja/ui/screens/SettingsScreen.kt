...
fun SettingsScreen(
        ...
        onNavigateToReviewInsights: () -> Unit,
        onNavigateToAdvancedIntegrations: () -> Unit,
                ...
                when (action) {
                        is SettingsSearchAction.OpenDestination -> {
                                when (action.destination) {
                                        ...
                                        SettingsDestinationId.LANGUAGE -> onNavigateToLanguage()
                                        SettingsDestinationId.REVIEW_INSIGHTS -> onNavigateToReviewInsights()
                                        SettingsDestinationId.ADVANCED_INTEGRATIONS -> onNavigateToAdvancedIntegrations()
                                        SettingsDestinationId.HELP_ABOUT -> onNavigateToHelpAbout()
                                }
                        }
                }
        }
                ...
                Box(modifier = Modifier.fillMaxSize().padding(paddingValues)) {
                        AppScreenReveal(
                                ...
                                Column(
                                        ...
                                        LanguageEntrySection(onNavigateToLanguage = onNavigateToLanguage)

                                        ReviewInsightsEntrySection(
                                                onNavigateToReviewInsights = onNavigateToReviewInsights
                                        )

                                        AdvancedIntegrationsEntrySection(
                                                onNavigateToAdvancedIntegrations =
                                                        onNavigateToAdvancedIntegrations
                                        )

                                        HelpAboutEntrySection(onNavigateToHelpAbout = onNavigateToHelpAbout)
