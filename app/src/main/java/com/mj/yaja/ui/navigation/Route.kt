...
sealed class Route(val path: String) {
    ...
    data object LanguageSettings : Route("language_settings")
    data object ReviewInsightsSettings : Route("review_insights_settings")
    data object AdvancedIntegrationsSettings : Route("advanced_integrations_settings")
    data object HelpAboutSettings : Route("help_about_settings")
