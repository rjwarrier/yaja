...
internal object SettingsSearchRegistry {
    val entries: List<SettingsSearchEntry> = listOf(
        ...
        entry(SettingsSearchEntryId.UI_SIZE, R.string.settings_ui_size_label, R.string.settings_appearance, "display size", "ui scale", "zoom", "bigger", destination = SettingsDestinationId.APPEARANCE),
